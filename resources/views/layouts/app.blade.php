        ...
        <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    <li @yield('user')>
                        <a href="{{ route('home') }}" class="iq-waves-effect"><i class="las la-gamepad"></i><span>Home</span></a>
                    </li>
                </ul>
            </nav>
                                ...
                                <div class="iq-card shadow-none m-0">
                                    <div class="iq-card-body p-0 ">
                                        <div class="bg-primary p-3">
                                            <h5 class="mb-0 text-white line-height">Hello {{ \Illuminate\Support\Facades\Auth::user()->name }}</h5>
                                        </div>
